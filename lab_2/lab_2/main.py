...
# --- Flexible imports: utils/ or project root ---
try:
    from utils.Bronze_file import process_bronze_table
    from utils.Silver_file import process_silver_table
    from utils.Gold_file import process_gold_table  # rename in your Gold_file.py if needed
except ImportError:
    # fallback if files are at repository root
    from Bronze_file import process_bronze_table
    from Silver_file import process_silver_table
    from Gold_file import process_gold_table
